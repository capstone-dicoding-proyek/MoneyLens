...
export default function NavbarSide({ children }) {
  return (
    <div className="flex justify-center">
      <div className="w-67 h-screen bg-linear-to-bl md:w-40 from-[#2FA084] to-[#6FCF97] justify-center flex">
        <div className=" m-10 flex justify-center items-start pt-4">
          <div className="flex flex-col h-full space-y-10">
            ...
            <div className="flex gap-2 items-center  cursor-pointer hover:bg-white px-6 p-2 group rounded-md transition duration-300">
              <GoHomeFill className="text-white text-2xl md:text-md group-hover:text-[#2FA084]" />
              <div className="text-white font-bold md:text-md text-xl group-hover:text-[#2FA084]">
                Beranda
              </div>
            </div>
            {/* Profile Button */}
            <div className="flex gap-2 items-center  cursor-pointer hover:bg-white px-6 p-2 group rounded-md transition  duration-300">
              <FaUser className="text-white text-2xl md:text-sm group-hover:text-[#2FA084]" />
              <div className="text-white font-bold md:text-md text-xl group-hover:text-[#2FA084]">
                Profile
              </div>
            </div>
